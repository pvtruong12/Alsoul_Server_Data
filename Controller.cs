using Assets.Scripts.Assembly_CSharp.Mod.Auto;
using Assets.src.e;
using Assets.src.f;
using Assets.src.g;
using System;
...
public class Controller : IMessageHandler
{
        ...
        try
        {
            ...
            switch (msg.command)
            {
                ...
                case 65:
                    {
                        ...
                        if (ItemTime.isExistMessage(b62))
                        {
                            if (num151 != 0)
                            {
                                ItemTime.getMessageById(b62).initTimeText(b62, text6, num151);
                            }
                            else
                            {
                                GameScr.textTime.removeElement(ItemTime.getMessageById(b62));
                            }
                        }
                        else
                        {
                            ItemTime itemTime = new ItemTime();
                            itemTime.initTimeText(b62, text6, num151);
                ...
                case -95:
                    {
                        ...
                        if (b49 == 0)
                        {
                            ...
                            else
                            {
                                ...
                                if (obj != null)
                                {
                                    Mob mob6 = new Mob(num117, false, false, false, false, false, templateId, 1, num118, 0, num118, (short)obj.cx, (short)obj.cy, 4, 0);
                                    mob6.isMobMe = true;
                                    obj.mobMe = mob6;
                        ...
                        if (b49 == 1)
                        {
                            ...
                            {
                                obj = GameScr.findCharInMap(num119);
                        ...
                        if (b49 == 2)
                        {
                            ...
                            if (num120 == Char.myCharz().charID)
                            {
                                ...
                                if (obj != null)
                                {
                                    ...
                                    {
                                        obj.doInjure(num122, 0, false, true);
                                    }
                                    else
                                    {
                        ...
                        if (b49 == 5)
                        {
                            ...
                            obj = null;
                            obj = ((num125 != Char.myCharz().charID) ? GameScr.findCharInMap(num125) : Char.myCharz());
                            if (obj == null)
                            {
                                return;
                            }
                ...
                case -90:
                    {
                        ...
                        Res.outz("===> UPDATE_BODY:    type = " + b51);
                        obj = ((Char.myCharz().charID != num134) ? GameScr.findCharInMap(num134) : Char.myCharz());
                        if (b51 != -1)
                        {
                            ...
                            sbyte isSuperFide = msg.reader().readByte();
                            sbyte isSuperCell = msg.reader().readByte();
                            Res.err("====> Cmd: -90 UPDATE_BODY   \n  isMonkey= " + b52 + " head=  " + num135 + " body= " + num136 + " legU= " + num137);
                            if (obj != null)
                            {
                                if (obj.charID == num134)
                                {
                                    obj.isMask = true;
                                    obj.isMonkey = b52;
                                    obj.isSuperFide = isSuperFide;
                                    obj.isSuperCell = isSuperCell;
                                    if (obj.isSuperFide != 0)
                                    {
                                        obj.isWaitMonkey = false;
                                        obj.isLockMove = false;
                                    }
                                    if (obj.isSuperCell != 0)
                                    {
                                        obj.isWaitSuperCell = false;
                                        obj.isLockMove = false;
                                    }
                                    if (obj.isMonkey != 0)
                                    {
                ...
                case -86:
                    {
                        ...
                        if (b21 == 1)
                        {
                            ...
                            Char obj5 = GameScr.findCharInMap(num35);
                            if (obj5 == null)
                            {
                                return;
                            }
                            GameCanvas.panel.setTypeGiaoDich(obj5);
                            GameCanvas.panel.show();
                ...
                case -112:
                    {
                        ...
                        if (b69 == 0)
                        {
                            int mobIndex = msg.reader().readShort();
                            GameScr.findMobInMap(mobIndex).clearBody();
                        }
                        if (b69 == 1)
                        {
                            int mobIndex2 = msg.reader().readShort();
                ...
                case -82:
                    {
                        ...
                        TileMap.tileIndex = new int[b41][][];
                        TileMap.tileType = new int[b41][];
                        for (int num96 = 0; num96 < b41; num96++)
                        {
                            sbyte b42 = msg.reader().readByte();
                            TileMap.tileType[num96] = new int[b42];
                            TileMap.tileIndex[num96] = new int[b42][];
                            for (int num97 = 0; num97 < b42; num97++)
                            {
                                TileMap.tileType[num96][num97] = msg.reader().readInt();
                                sbyte b43 = msg.reader().readByte();
                                TileMap.tileIndex[num96][num97] = new int[b43];
                                for (int num98 = 0; num98 < b43; num98++)
                                {
                ...
                case -80:
                    {
                        ...
                        if (b47 == 0)
                        {
                            ...
                            for (int num102 = 0; num102 < num101; num102++)
                            {
                                ...
                                obj8.bag = msg.reader().readUnsignedByte();
                ...
                case -93:
                    {
                        ...
                        BgItem.newSmallVersion = new int[num109];
                        for (int num110 = 0; num110 < num109; num110++)
                        {
                            BgItem.newSmallVersion[num110] = msg.reader().readInt();
                        }
                        break;
                    }
                case -77:
                ...
                case -76:
                    {
                        ...
                        if (b6 == 0)
                        {
                            ...
                            for (int i = 0; i < b7; i++)
                            {
                                ...
                                Char.myCharz().arrArchive[i].strMoney = msg.reader().readUTF();
                ...
                case -74:
                    {
                        ...
                        if (b25 == 4)
                        {
                            try
                            {
                                int bgId = msg.reader().readInt();
                                int bgSize = msg.reader().readInt();
                                sbyte[] bgData = new sbyte[bgSize];
                                msg.reader().read(ref bgData, 0, bgSize);
                                string filename = "x" + mGraphics.zoomLevel + "bgItem" + bgId;
                                Rms.saveRMS(filename, bgData);
                                ServerListScreen.demPercent++;
                                ServerListScreen.percent = ServerListScreen.demPercent * 100 / ServerListScreen.nBig;
                            }
                            catch (Exception)
                        ...
                        if (b25 == 3 && flag5)
                        {
                            ...
                            // Chuyển sang bg phase ngay lập tức
                            ServerListScreen.bgDownloadPhase = true;
                            ServerListScreen.bgDownloadedBytes = 0;
                            ServerListScreen.bgTotalBytes = 0;
                            Service.gI().getResource(5, null);
                        }
                        if (b25 == 5)
                        {
                            // Nhận CDN URL, bắt đầu tải HTTP
                            string bgUrl = msg.reader().readUTF();
                            BgDownloader.gI().startDownload(bgUrl);
                        }
                        if (b25 == 6)
                        {
                            // Không có CDN, bỏ qua bg download -> login luôn
                            Service.gI().getResource(3, null);
                            GameCanvas.endDlg();
                            SplashScr.imgLogo = null;
                            SmallImage.loadBigRMS();
                ...
                case -43:
                    {
                        ...
                        GameCanvas.panel.itemRequest(itemAction, info3, b38, index);
                        break;
                    }
                case -59:
                    {
                ...
                case -65:
                    {
                        ...
                        if (Char.myCharz().charID == num100)
                        {
                            ...
                            if (b45 == 0 || b45 == 1 || b45 == 3)
                            {
                                Teleport p2 = new Teleport(Char.myCharz().cx, Char.myCharz().cy, Char.myCharz().head, Char.myCharz().cdir, 0, true, (b45 != 1) ? b45 : Char.myCharz().cgender);
                        ...
                        {
                            Char obj6 = GameScr.findCharInMap(num100);
                            if ((b45 == 0 || b45 == 1 || b45 == 3) && obj6 != null)
                            {
                                obj6.isUsePlane = true;
                                Teleport teleport = new Teleport(obj6.cx, obj6.cy, obj6.head, obj6.cdir, 0, false, (b45 != 1) ? b45 : obj6.cgender);
                                teleport.id = num100;
                ...
                case -64:
                    {
                        ...
                        obj = null;
                        obj = ((num24 != Char.myCharz().charID) ? GameScr.findCharInMap(num24) : Char.myCharz());
                        obj.bag = num25;
                        ...
                        else
                        {
                            ...
                            {
                                obj.removeEffChar(0, 201 + num26);
                            }
                        }
                        Res.outz("cmd:-64 UPDATE BAG PLAER = " + ((obj != null) ? obj.cName : string.Empty) + num24 + " BAG ID= " + num25);
                        break;
                    }
                case -63:
                    {
                ...
                case -35:
                    {
                        ...
                        if (b70 == 2)
                        {
                            ...
                            Char.myCharz().arrItemBox[b72].quantity = quantity3;
                            if (Char.myCharz().arrItemBox[b72].quantity == 0)
                            {
                                Char.myCharz().arrItemBox[b72] = null;
                            }
                        }
                        break;
                    }
                case -45:
                    {
                        ...
                        Res.outz(">.SKILL_NOT_FOCUS  skill type= " + b54 + "   player use= " + num145);
                        if (b54 == 20)
                        {
                            ...
                            Res.outz(">.SKILL_NOT_FOCUS  skill playerDir= " + b55);
                            obj = ((Char.myCharz().charID != num145) ? GameScr.findCharInMap(num145) : Char.myCharz());
                            obj.SetSkillPaint_NEW(num146, isFly, typeFrame, typePaint, b55, timeGong, typeItem);
                        }
                        if (b54 == 21)
                        {
                            ...
                            obj.SetSkillPaint_STT(1, num146, point, timeDame, rangeDame, typePaint2, array13, typeItem2);
                        }
                        if (b54 == 0)
                        {
                            ...
                            {
                                obj = GameScr.findCharInMap(num145);
                                if ((TileMap.tileTypeAtPixel(obj.cx, obj.cy) & 2) == 2)
                                {
                                    obj.setSkillPaint(GameScr.sks[num146], 0);
                                }
                                else
                                {
                                    obj.setSkillPaint(GameScr.sks[num146], 1);
                                    obj.delayFall = 20;
                                }
                            }
                            else
                            ...
                            for (int num148 = 0; num148 < b57; num148++)
                            {
                                ...
                                {
                                    ((Mob)GameScr.vMob.elementAt(b58)).isFreez = true;
                                    ((Mob)GameScr.vMob.elementAt(b58)).seconds = b59;
                                    ((Mob)GameScr.vMob.elementAt(b58)).last = (((Mob)GameScr.vMob.elementAt(b58)).cur = mSystem.currentTimeMillis());
                                }
                            }
                            ...
                            for (int num149 = 0; num149 < b60; num149++)
                            {
                                ...
                                {
                                    obj = GameScr.findCharInMap(num150);
                                    if (obj != null && !obj.isFlyAndCharge && !obj.isStandAndCharge)
                                    {
                                        obj.isFreez = true;
                                        obj.seconds = b61;
                                        obj.freezSeconds = b61;
                                        obj.lastFreez = (GameScr.findCharInMap(num150).currFreez = mSystem.currentTimeMillis());
                                    }
                                }
                            }
                        }
                        if (b54 == 1 && num145 != Char.myCharz().charID)
                        {
                        ...
                        if (b54 == 4)
                        {
                            if (num145 == Char.myCharz().charID)
                            {
                                short rawSeconds = msg.reader().readShort();
                                Char.myCharz().seconds = rawSeconds - 1000;
                        ...
                        if (b54 == 8 && num145 != Char.myCharz().charID && GameScr.findCharInMap(num145) != null)
                        {
                            GameScr.findCharInMap(num145).setAutoSkillPaint(GameScr.sks[num146], 0);
                        }
                        break;
                ...
                case -66:
                    {
                        ...
                        {
                            effDataById.readDataNewBoss(data5, b64);
                        }
                        ...
                        short[][] array16 = new short[b65][];
                        for (int num154 = 0; num154 < b65; num154++)
                        {
                ...
                case -32:
                    {
                        ...
                        try
                        {
                            ...
                            msg.reader().readFully(ref array12);
                        ...
                        if (array12 != null)
                        {
                            ...
                            {
                                string filename = "x" + mGraphics.zoomLevel + "bgItem" + num141;
                                Rms.saveRMS(filename, array12);
                            }
                ...
                case 92:
                    {
                        ...
                        GameScr.info2.addInfoWithChar(empty, obj7, b46 == 0);
                ...
                case 81:
                    {
                        ...
                        Mob mob4 = (Mob)GameScr.vMob.elementAt(msg.reader().readShort());
                ...
                case 56:
                    {
                        ...
                        if (num9 == Char.myCharz().charID)
                        {
                            ...
                            try
                            {
                                ...
                                if (b13 != -1)
                                {
                                    ...
                                    EffecMn.addEff(new Effect(b13, obj.cx, obj.cy, 3, 1, -1));
                                }
                            }
                            catch (Exception)
                            {
                            ...
                            if (Char.myCharz().cTypePk != 4)
                            {
                                ...
                                {
                                    GameScr.startFlyText("-" + num16, obj.cx, obj.cy - obj.ch, 0, -3, flag3 ? mFont.FATAL : mFont.RED);
                                }
                            }
                            break;
                        }
                        ...
                        try
                        {
                            ...
                            if (b14 != -1)
                            {
                                ...
                                EffecMn.addEff(new Effect(b14, obj.cx, obj.cy, 3, 1, -1));
                            }
                        }
                        catch (Exception)
                        {
                        ...
                        if (obj.cTypePk != 4)
                        {
                            ...
                            {
                                GameScr.startFlyText("-" + num18, obj.cx, obj.cy - obj.ch, 0, -3, flag4 ? mFont.FATAL : mFont.ORANGE);
                            }
                        }
                        break;
                    }
                case 83:
                    {
                        ...
                        int num9 = msg.reader().readInt();
                        obj = ((num9 != Char.myCharz().charID) ? GameScr.findCharInMap(num9) : Char.myCharz());
                        if (obj == null)
                        {
                            return;
                        }
                        Mob mobToAttack = (Mob)GameScr.vMob.elementAt(msg.reader().readShort());
                        if (obj.mobMe != null)
                        {
                ...
                case 58:
                    {
                        ...
                        int num9 = msg.reader().readInt();
                        Char obj10 = ((num9 != Char.myCharz().charID) ? GameScr.findCharInMap(num9) : Char.myCharz());
                        obj10.moveFast = new short[3];
                        obj10.moveFast[0] = 0;
                        short num172 = msg.reader().readShort();
                        short num173 = msg.reader().readShort();
                        obj10.moveFast[1] = num172;
                        obj10.moveFast[2] = num173;
                        try
                        {
                            num9 = msg.reader().readInt();
                            Char obj11 = ((num9 != Char.myCharz().charID) ? GameScr.findCharInMap(num9) : Char.myCharz());
                            obj11.cx = num172;
                            obj11.cy = num173;
                        }
                ...
                case 50:
                    {
                        ...
                        for (int num138 = 0; num138 < b53; num138++)
                        {
                ...
                case -19:
                    {
                        ...
                        for (int num112 = 0; num112 < GameScr.vItemMap.size(); num112++)
                        {
                            ...
                            itemMap.setPoint(obj.cx, obj.cy - 10);
                            if (itemMap.x < obj.cx)
                            {
                                obj.cdir = -1;
                            }
                            else if (itemMap.x > obj.cx)
                            {
                                obj.cdir = 1;
                            }
                            break;
                ...
                case 6:
                    ...
                    break;
                case -24:
                    CrashLogger.Write("[MAP] -24 START");
                    CrashLogger.ResetOnceTags();
                    Char.isLoadingMap = true;
                    GameScr.gI().magicTree = null;
                    GameCanvas.isLoading = true;
                    CrashLogger.Write("[MAP] before resetAllvector");
                    GameScr.resetAllvector();
                    CrashLogger.Write("[MAP] after resetAllvector");
                    GameCanvas.endDlg();
                    TileMap.vGo.removeAllElements();
                    PopUp.vPopups.removeAllElements();
                    // Giải phóng texture bg của map cũ - tránh memory leak trên iOS
                    CrashLogger.Write("[MAP] clearHashTable");
                    BgItem.clearHashTable();
                    CrashLogger.Write("[MAP] before gcc");
                    mSystem.gcc();
                    Resources.UnloadUnusedAssets();
                    CrashLogger.Write("[MAP] after gcc, reading header");
                    ...
                    CrashLogger.Write("[MAP] header done: mapID=" + TileMap.mapID + " zoneID=" + TileMap.zoneID);
                    try
                    {
                        CrashLogger.Write("[MAP] before loadMapFromResource");
                        TileMap.loadMapFromResource(TileMap.mapID);
                        CrashLogger.Write("[MAP] after loadMapFromResource");
                    }
                    catch (Exception e)
                    {
                        CrashLogger.Write("[MAP] loadMapFromResource FAIL: " + e.Message);
                        Service.gI().requestMaptemplate(TileMap.mapID);
                        messWait = msg;
                        return;
                    }
                    CrashLogger.Write("[MAP] before loadInfoMap");
                    loadInfoMap(msg);
                    CrashLogger.Write("[MAP] after loadInfoMap");
                    try
                    {
                    ...
                    CrashLogger.Write("[MAP] -24 DONE");
                    CrashLogger.LogMemory("map=" + TileMap.mapID);
                    break;
                case -31:
                    {
                        CrashLogger.Write("[-31] START");
                        TileMap.vItemBg.removeAllElements();
                        short num52 = msg.reader().readShort();
                        CrashLogger.Write("[-31] nItem=" + num52);
                        for (int num53 = 0; num53 < num52; num53++)
                        {
                            BgItem bgItem = new BgItem();
                            bgItem.id = num53;
                            bgItem.idImage = msg.reader().readInt();
                ...
                case -4:
                    {
                        ...
                        obj.attMobs = new Mob[msg.reader().readShort()];
                        for (int n = 0; n < obj.attMobs.Length; n++)
                        {
                            Mob mob3 = (Mob)GameScr.vMob.elementAt(msg.reader().readShort());
                            obj.attMobs[n] = mob3;
                            if (n == 0)
                            {
                                if (obj.cx <= mob3.x)
                        ...
                        try
                        {
                            ...
                            {
                                int num9 = msg.reader().readInt();
                                Char obj4 = (array[num] = ((num9 != Char.myCharz().charID) ? GameScr.findCharInMap(num9) : Char.myCharz()));
                                if (num == 0)
                                {
                                    if (obj.cx <= obj4.cx)
                                    {
                ...
                case 54:
                    {
                        ...
                        if ((TileMap.tileTypeAtPixel(obj.cx, obj.cy) & 2) == 2)
                        {
                            obj.setSkillPaint(GameScr.sks[num10], 0);
                        }
                        else
                        {
                            obj.setSkillPaint(GameScr.sks[num10], 1);
                        }
                        ...
                        try
                        {
                            ...
                            {
                                Mob mob2 = (array2[num] = (Mob)GameScr.vMob.elementAt(msg.reader().readShort()));
                                if (num == 0)
                                {
                                    if (obj.cx <= mob2.x)
                                    {
                ...
                case -73:
                    {
                        ...
                        for (int num195 = 0; num195 < GameScr.vNpc.size(); num195++)
                        {
                            ...
                            if (npc7.template.npcTemplateId == b80)
                            {
                ...
                case -5:
                    {
                        ...
                        if (readCharInfo(obj15, msg))
                        {
                            ...
                            if (obj15.cy <= 10 && b76 != 0 && b76 != 2)
                            {
                                Res.outz("nhân vật bay trên trời xuống x= " + obj15.cx + " y= " + obj15.cy);
                                Teleport teleport2 = new Teleport(obj15.cx, obj15.cy, obj15.head, obj15.cdir, 1, false, (b76 != 1) ? b76 : obj15.cgender);
                        ...
                        try
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    obj15.removeEffChar(0, 201 + num189);
                                }
                            }
                        }
                        ...
                        obj15.isSuperFide = msg.reader().readByte();
                        obj15.isSuperCell = msg.reader().readByte();
                        GameScr.gI().getFlagImage(obj15.charID, obj15.cFlag);
                        Res.outz("Cmd: -5 PLAYER_ADD: cID| cName| cFlag| cBag|    " + obj.charID + " | " + obj.cName + " | " + obj.cFlag + " | " + obj.bag);
                        break;
                    }
                case -7:
                    {
                        ...
                        for (int num182 = 0; num182 < GameScr.vCharInMap.size(); num182++)
                        {
                            ...
                            try
                            {
                                obj14 = (Char)GameScr.vCharInMap.elementAt(num182);
                            }
                ...
                case -6:
                    {
                        ...
                        {
                            Char obj13 = (Char)GameScr.vCharInMap.elementAt(num180);
                            if (obj13 != null && obj13.charID == num179)
                            {
                ...
                case -13:
                    {
                        ...
                        int num191 = msg.reader().readShort(); // FIX: mob limits
                ...
                case -75:
                    {
                        ...
                        try
                        {
                            mob9 = (Mob)GameScr.vMob.elementAt(msg.reader().readShort());
                        }
                        catch (Exception)
                        {
                        }
                ...
                case -9:
                    {
                        ...
                        if (mob9 != null)
                        {
                            ...
                            if (b75 != -1)
                            {
                                EffecMn.addEff(new Effect(b75, mob9.x, mob9.getY(), 3, 1, -1));
                            }
                            GameCanvas.debug("SA83v2", 2);
                            if (flag10)
                            {
                ...
                case -12:
                    {
                        ...
                        try
                        {
                            ...
                            for (int num193 = 0; num193 < b79; num193++)
                            {
                ...
                case -11:
                    {
                        ...
                        try
                        {
                            int index4 = msg.reader().readShort();
                ...
                case 44:
                    {
                        ...
                        obj = ((Char.myCharz().charID != num178) ? GameScr.findCharInMap(num178) : Char.myCharz());
                        if (obj == null)
                        {
                            return;
                        }
                ...
                case 18:
                    {
                        ...
                        for (int num175 = 0; num175 < b73; num175++)
                        {
                            int charId = msg.reader().readInt();
    ...
    private void createMap(myReader d)
    {
        ...
        Mob.arrMobTemplate = new MobTemplate[d.readInt()];
    ...
    public static int pendingBgID = -2;

    public static void processPendingBG()
    {
        if (pendingBgID != -2)
        {
            GameCanvas.loadBG(pendingBgID);
            pendingBgID = -2;
        }
    }
    ...
    public void loadCurrMap(sbyte teleport3)
    {
        ...
        GameScr.gI().loadGameScr();
        // Defer loadBG sang frame sau để InfoDlg.hide() chạy trước
        pendingBgID = TileMap.bgID;
        Char.isLockKey = false;
    ...
    public void loadInfoMap(Message msg)
    {
        try
        {
            ...
            // mSystem.gcc(); // Bỏ: GC sync gây freeze khi load map
            ...
            for (int b = 0; b < num; b++)
            {
                Mob mob = new Mob(b, msg.reader().readBoolean(), msg.reader().readBoolean(), msg.reader().readBoolean(), msg.reader().readBoolean(), msg.reader().readBoolean(), msg.reader().readShort(), msg.reader().readByte(), msg.reader().readInt(), msg.reader().readByte(), msg.reader().readInt(), msg.reader().readShort(), msg.reader().readShort(), msg.reader().readByte(), msg.reader().readByte());
                mob.xSd = mob.x;
                mob.ySd = mob.y;
            ...
            if (!GameCanvas.lowGraphic || (GameCanvas.lowGraphic && TileMap.isVoDaiMap()) || TileMap.mapID == 45 || TileMap.mapID == 46 || TileMap.mapID == 47 || TileMap.mapID == 48)
            {
                ...
                for (int n = 0; n < num5; n++)
                {
                    ...
                    {
                        // Thử load từ cache ngay lập tức thay vì tạo placeholder
                        Image cachedImage = null;
                        bool needServerRequest = false;

                        if (mGraphics.zoomLevel == 1)
                        {
                            cachedImage = GameCanvas.loadImage("/mapBackGround/" + bgItem.idImage + ".png");
                        }
                        else
                        {
                            // Check RMS cache trước
                            string filename = "x" + mGraphics.zoomLevel + "bgItem" + bgItem.idImage;
                            sbyte[] cachedData = Rms.loadRMS(filename);
                            if (cachedData != null)
                            {
                                // Version check
                                ...
                                {
                                    if (cachedData.Length % 127 != BgItem.newSmallVersion[bgItem.idImage])
                                    {
                                ...
                                if (!versionMismatch)
                                {
                                    cachedImage = Image.createImage(cachedData, 0, cachedData.Length);
                                }
                            }
                            // Fallback: thử load từ local asset
                            if (cachedImage == null)
                            {
                                cachedImage = GameCanvas.loadImage("/mapBackGround/" + bgItem.idImage + ".png");
                            }
                        ...
                        if (cachedImage != null)
                        {
                            // Có cache → dùng ngay, không cần request server
                            image = cachedImage;
                            BgItem.imgNew.put(bgItem.idImage + string.Empty, image);
                        }
                        else
                        {
                            // Không có cache → placeholder + request server
                        ...
                        {
                            BgItemMn.pendingImageLoads.Enqueue(new BgItemMn.ImageLoadTask { idImage = bgItem.idImage });
                        }
            ...
            ModXmap.updateWaypointChangeMap();
        }
        catch (Exception ex)
        {
                ...
                case 11:
                    {
                        ...
                        // Skip nếu đã có trong memory
                        if (TileMap.MapData.getMap(map.mapId) != null)
                        {
                            // Đọc hết data để skip đúng
    ...
    public void messageNotLogin(Message msg)
    {
        try
        {
            ...
            switch (b)
            {
                ...
                case 3:
                    {
                        // Đăng ký thành công → server gửi tk/mk → tự login
                        string regUsername = msg.reader().readUTF();
                        string regPassword = msg.reader().readUTF();
                        Res.outz("Register success, auto login: " + regUsername);
                        // Lưu tài khoản vào Rms
                        Rms.saveRMSString("acc", regUsername);
                        Rms.saveRMSString("pass", regPassword);
                        // Clear RegisterScreen
                        if (GameCanvas.registerScr != null)
                        {
                            GameCanvas.registerScr.clearFields();
                        }
                        // Chuyển sang LoginScr và tự động login (giống flow "Chơi TK")
